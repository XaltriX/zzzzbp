...
- Request to join channel feature
- Support multiple force request joining channel
- Sequence Limit feature 
...
status - get total user and pythons version

info - check or get user info

limit - check start cmd use limit
```
...
* `REQ_JOIN_LINK ` You have to add approvel link 
